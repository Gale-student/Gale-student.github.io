...
public class OrdersDetailQueryAllServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<OrdersDetail> ordersDetailList = ordersService.selectOrdersDetail(uid, 0);
			int allRows = ordersService.OrdersDetailAllRows(uid);
