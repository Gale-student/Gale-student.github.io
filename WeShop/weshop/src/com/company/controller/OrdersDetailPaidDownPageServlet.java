...
public class OrdersDetailPaidDownPageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {	
			if(currentPage < allPage){
				...
				List<OrdersDetail> ordersDetailList = ordersService.queryPaidOrdersDetail(uid, currentPage - 1);
