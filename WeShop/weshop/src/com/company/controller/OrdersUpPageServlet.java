...
public class OrdersUpPageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(ordersCurrentPage <= 1 ){//Ê×Ò³
				  ...
				  List<Orders> ordersList = ordersService.ordersPagingQuery(ordersCurrentPage - 2);
