...
<html>
  <head>
    ...
    <title>My JSP 'OrdersQueryOfUser.jsp' starting page</title>
  ...
  <body>
    <div>
        <img style="position: absolute;width: 200px; height: 220px; top: 200px;" src="/bimage/gaoqian.jpg">
    </div>
    ...
    <form action="OrdersDetailUpQueryAllOfUserServlet" method="post">
       <input type="submit" value=<%=upPage %>>
    </form>
    <label style="position: absolute; top: 0px; left: 65px;"><%=currentPage + "/" + allPage %></label>
    <form style="position: absolute; top: 0px; left: 100px;" action="OrdersDetailDownQueryAllOfUserServlet" method="post">
